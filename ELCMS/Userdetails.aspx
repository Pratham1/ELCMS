          ...
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                ...
                <input class="form-control" id="txt_Name" type="text" aria-describedby="nameHelp" placeholder="User name">
              </div>
              <div class="col-md-6">
                <label for="lbl_GroupName">Group name</label>
                <input class="form-control" id="txt_GroupName" type="text" aria-describedby="nameHelp" placeholder="Group name">
              </div>
            </div>
          </div>
		  <table width="70%" class="table table-striped table-bordered table-hover" id="dataTables-example">
            ...
            <tbody>
                <tr class="odd gradeX">
                    ...
                    <td>
						<a class="nav-link" href="maintops.html">
